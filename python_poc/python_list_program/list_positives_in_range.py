def user_input():
    print("this program will print positive number in given array in a range which will give by user")
    start = int(input("Enter the starting number: "))
    end = int(input("Enter the ending number :"))
    return start, end


def positive_in_range(list_container, start, end):
    list_positives = []
...
def main():
    ...
    list_positive = positive_in_range(list_container, start, end)
